          ...
          children: [
            ...
            Row(
              children: [
                ...
                if (controller.store!.rating != null) ...[
                  ...
                  Text(
                    controller.store!.displayRating,
                    style: AppTextStyles.bodyMedium.copyWith(
                      fontWeight: FontWeight.w600,
                    ),
                  ),
                ...
                if (controller.store!.distance != null)
                  Container(
                    ...
                    child: Text(
                      controller.store!.displayDistance,
                      style: AppTextStyles.bodyMedium.copyWith(
                        color: AppColors.primary,
                        fontWeight: FontWeight.w600,
                      ),
            ...
            if (controller.store!.openTime != null &&
              ...
              _buildStoreDetailRow(
                Icons.access_time,
                controller.store!.operationalHours,
              ),
        ...
        return ListView.separated(
          ...
          itemBuilder: (context, index) {
            ...
            return MenuItemCard(
              ...
              // Fix: gunakan signature yang benar sesuai dengan controller
